...
export default function LandingPage() {
  ...
  const handleGitHub = () => {
    window.open(
      "https://github.com/starboyles/multi-modal-video-analysis-tool",
      "_blank"
    );
  };
  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="sm:mx-auto lg:mt-0 lg:mr-auto">
                ...
                <p className="mt-8 max-w-2xl text-lg text-pretty">
                  The intelligent unimodal video analysis tool with AI-powered
                  chat. Upload any YouTube video and get instant insights,
                  section breakdowns, and interactive conversations about the
                  content.
                </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 min-h-[400px] sm:h-[500px]">
                <div className="lg:col-span-2 bg-gray-800 rounded-xl sm:rounded-2xl flex items-center justify-center">
                  <div className="text-center text-gray-400 p-4">
                    ...
                    <p className="text-sm opacity-75">
                      Interactive video with AI-powered analysis
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 flex flex-col">
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    ...
                    <Button
                      size="sm"
                      className="bg-gray-900 text-white rounded-full px-3"
                    >
                      New Chat
                    </Button>
                  </div>
                  ...
                  <div className="flex-1 space-y-3 sm:space-y-4">
                    ...
                    <div className="text-gray-700 text-sm leading-relaxed">
                      This video covers several key programming concepts
                      including variables, functions, and data structures. The
                      main sections are:
                    </div>
        ...
        <section
          id="features"
          className="mt-8 px-6 py-12 sm:mt-12 sm:py-16 md:mt-20 lg:py-20"
        >
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Interactive conversations about video content with intelligent
                  responses and timestamp citations.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Automatic video segmentation with intelligent timestamps and
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Find specific moments in videos using natural language
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Seamless integration with YouTube videos while maintaining
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 text-xs sm:text-sm ml-2">
                © 2025 Argus, All rights reserved.
              </span>
            </div>
